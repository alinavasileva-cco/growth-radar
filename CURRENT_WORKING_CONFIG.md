...
**Версия:** 09.08.2026  
**Последний подтверждённый запуск:** `N5K-20260809-137`  
...
- baseline_count: **0**;
- текущий канонический итог: **116**;
- текущий contactable итог: **116**;
- осталось до цели: **4884**;
...
- последний отчёт: `reports/run_2026-08-09_137.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **2**;
- добавленных компаний: **2** — `N5K-0115 КД-ойл / ООО «КД-ОЙЛ»`, `N5K-0116 Европодшипник М / ООО «ЕВРОПОДШИПНИК М»`;
