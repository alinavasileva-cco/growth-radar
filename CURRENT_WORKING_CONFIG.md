...
**Версия:** 10.08.2026  
**Последний подтверждённый запуск:** `N5K-20260810-159`  
...
- baseline_count: **0**;
- текущий канонический итог: **146**;
- текущий contactable итог: **146**;
- осталось до цели: **4854**;
...
- последний отчёт: `reports/run_2026-08-10_159.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленных компаний: **1** — `N5K-0146 Торг-Лайт / ACELED / ООО «ТОРГ-ЛАЙТ»`;
