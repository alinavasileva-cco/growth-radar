...
**Версия:** 11.08.2026  
**Последний запуск:** `N5K-20260811-191`  
**Статус:** `PENDING_MAIN_RUN_LOG_APPEND` — канонические данные интегрированы, integrity PASS; требуется безопасно добавить RUN 189, RUN 190 и RUN 191 в общий campaign run_log.csv  
...
- baseline_count: **0**;
- текущий канонический итог: **189**;
- текущий contactable итог: **189**;
- осталось до цели: **4811**;
...
- последний отчёт: `reports/run_2026-08-11_191.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавлен: `N5K-0189 Лесресурс / ООО «ЛЕСРЕСУРС»`;
...
- orphan contacts: **0**;
- orphan evidence: **0**;
- blocker: `PENDING_MAIN_RUN_LOG_APPEND_189_190_191`;
