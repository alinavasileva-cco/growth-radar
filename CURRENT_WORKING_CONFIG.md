...
**Версия:** 07.08.2026  
**Последний подтверждённый запуск:** `N5K-20260807-106`  
...
- baseline_count: **0**;
- текущий канонический итог: **71**;
- текущий contactable итог: **71**;
- осталось до цели: **4929**;
...
- последний отчёт: `reports/run_2026-08-07_106.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленная компания: **ЕГЭLAND / ООО «ЕГЭЛЭНД»**;
