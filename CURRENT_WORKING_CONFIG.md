...
**Версия:** 09.08.2026  
**Последний подтверждённый запуск:** `N5K-20260809-139`  
...
- baseline_count: **0**;
- текущий канонический итог: **118**;
- текущий contactable итог: **118**;
- осталось до цели: **4882**;
...
- последний отчёт: `reports/run_2026-08-09_139.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленных компаний: **1** — `N5K-0118 19LAB / ООО «СУРИН»`;
- подтверждённые дубли: **13**;
