...
**Версия:** 07.08.2026  
**Последний подтверждённый запуск:** `N5K-20260807-102`  
...
- baseline_count: **0**;
- текущий канонический итог: **67**;
- текущий contactable итог: **67**;
- осталось до цели: **4933**;
...
- последний отчёт: `reports/run_2026-08-07_102.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **2**;
- добавленные компании: **Макошь / ООО «МАКОШЬ»**; **NL Group / ООО «ЭНЭЛ ГРУП»**;
