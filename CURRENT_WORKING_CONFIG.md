...
**Версия:** 07.08.2026  
**Последний подтверждённый запуск:** `N5K-20260807-091`  
...
- baseline_count: **0**;
- текущий канонический итог: **54**;
- текущий contactable итог: **54**;
- осталось до цели: **4946**;
...
- последний отчёт: `reports/run_2026-08-07_091.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленные компании: **Идеальный турник / ООО «СИСТЕМА НАЙМА»**;
- дубли: **13**;
...
- blocker: отсутствует для квалифицированной компании; остальные кандидаты не повышались без полной проверки legal → scale → LPR → signal → contact.