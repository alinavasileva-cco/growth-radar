...
**Версия:** 09.08.2026  
**Последний подтверждённый запуск:** `N5K-20260809-147`  
...
- baseline_count: **0**;
- текущий канонический итог: **132**;
- текущий contactable итог: **132**;
- осталось до цели: **4868**;
...
- последний отчёт: `reports/run_2026-08-09_147.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленных компаний: **1** — `N5K-0132 Logos LTD / Логос-ЛТД / ООО «ЛОГОС-ЛТД»`;
