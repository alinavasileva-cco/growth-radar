...
**Версия:** 12.08.2026  
**Последний запуск:** `N5K-20260812-213`  
**Статус:** `COMPLETED` — канонические RUN-shards интегрированы, integrity PASS, verified run-log tail продлён через RUN 213  
...
- baseline_count: **0**;
- текущий канонический итог: **216**;
- текущий contactable итог: **216**;
- осталось до цели: **4784**;
...
- последний отчёт: `reports/run_2026-08-12_213.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **2**;
- добавлены: `N5K-0215 Арена Авто`, `N5K-0216 Астрал-Софт`;
- подтверждённые дубли: **3**;
- исключено или не прошло полную квалификацию: **25**;
- ACTIVE WIP: **8**;
- integrity: **PASS**;
- orphan contacts: **0**;
- orphan evidence: **0**;
- verified tail дополнен RUN 213;
