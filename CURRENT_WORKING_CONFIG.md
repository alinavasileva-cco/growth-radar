...
**Версия:** 07.08.2026  
**Последний подтверждённый запуск:** `N5K-20260807-096`  
...
- baseline_count: **0**;
- текущий канонический итог: **60**;
- текущий contactable итог: **60**;
- осталось до цели: **4940**;
...
- последний отчёт: `reports/run_2026-08-07_096.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленная компания: **Ectem / ООО «ЭКТЕМ ОК»**;
