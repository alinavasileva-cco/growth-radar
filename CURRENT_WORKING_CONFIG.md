...
**Версия:** 2026-08-24T10:20:00+05:00  
**Последний полностью завершённый RUN:** `N5K-20260824-372`  
**Статус канонической базы:** ACTIVE / integrity PASS  
**Физически подтверждённый canonical/contactable:** **302 / 302**  
...
- physical canonical/contactable count: **302 / 302**;
- orphan contacts/evidence: **0 / 0**;
- последний завершённый RUN: `N5K-20260824-372`;
...
## Последний подробный RUN — N5K-20260824-372

Baseline перед RUN: **300 / 300**.  
Фактически индивидуально обработано raw-кандидатов: **18**. Целевые 150–200 в этом RUN не достигнуты и не заявляются.  
Воронка: discovered **18** → fast gate **5** → size **3** → legal **2** → signal **2** → LPR **2** → contact **2** → qualified **2** → physically integrated **2**.  
Duplicates: **7**. Excluded: **9**.  
Добавлены:
- **Силтрон / SILTRON — ООО «СИЛТРОН»**, ИНН `7708405173`, ОГРН `1227700275461`, Lead ID `N5K-0449`.
- **AQUADRENAG / Аквадренаж — ООО «АКВАДРЕНАЖ»**, ИНН `7722330459`, ОГРН `1157746523880`, Lead ID `N5K-0450`.

Итог physical canonical/contactable: **302 / 302**.  
...
## Latest verified run N5K-20260824-373
Canonical/contactable: 304/304. Integrity PASS. Orphan contacts/evidence: 0/0. Outreach: 0.
