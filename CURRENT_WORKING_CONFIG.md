...
**Версия:** 10.08.2026  
**Последний подтверждённый запуск:** `N5K-20260810-162`  
...
- baseline_count: **0**;
- текущий канонический итог: **150**;
- текущий contactable итог: **150**;
- осталось до цели: **4850**;
...
- последний отчёт: `reports/run_2026-08-10_162.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **2**;
- добавленных компаний: **2** — `N5K-0149 Лесресурс / ООО «ЛЕСРЕСУРС»`, `N5K-0150 Авто Сувенир / ООО «АВТО СУВЕНИР»`;
