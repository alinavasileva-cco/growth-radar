...
**Версия:** 07.08.2026  
**Последний подтверждённый запуск:** `N5K-20260807-097`  
...
- baseline_count: **0**;
- текущий канонический итог: **61**;
- текущий contactable итог: **61**;
- осталось до цели: **4939**;
...
- последний отчёт: `reports/run_2026-08-07_097.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленная компания: **РВШ.РФ / ООО «РВШ.РФ»**;
