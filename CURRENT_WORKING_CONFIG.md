...
**Версия:** 12.08.2026  
**Последний запуск:** `N5K-20260812-206`  
...
- baseline_count: **0**;
- текущий канонический итог: **206**;
- текущий contactable итог: **206**;
- осталось до цели: **4794**;
...
- последний отчёт: `reports/run_2026-08-12_206.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавлена: `N5K-0206 Прометекс / ООО «ПРОМЕТЕКС»`;
- подтверждённые дубли: **2**;
- исключено или не прошло полную квалификацию: **27**;
- ACTIVE WIP: **8**;
- integrity: **PASS**;
- orphan contacts: **0**;
- orphan evidence: **0**;
- aggregate `run_log.csv`: RUN 198–206 ещё не добавлены безопасной полной заменой;
- blocker: **только aggregate run_log.csv; полный blob усечён транспортом connector**;
