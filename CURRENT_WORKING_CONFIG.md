...
**Версия:** 2026-08-22T20:02:43+05:00  
**Последний полностью завершённый RUN:** `N5K-20260822-326`  
**Статус канонической базы:** ACTIVE / integrity PASS  
**Физически подтверждённый canonical/contactable:** **245 / 245**  
...
- physical canonical/contactable count: **245 / 245**;
- orphan contacts/evidence: **0 / 0**;
- последний завершённый RUN: `N5K-20260822-326`;
...
## Последний проверенный RUN — N5K-20260822-326

Baseline перед RUN: **244 / 244**.  
Фактически обработано raw: **20**. Требуемые 150–200 в этом RUN не достигнуты и не заявляются.  
Воронка: discovered **20** → fast gate **6** → size **3** → legal **2** → signal **1** → LPR **1** → contact **1** → qualified **1** → physically integrated **1**.  
Duplicates: **4**. Excluded: **15**.  
Добавлена: **Окна Столицы / ООО «ПК «ОКНА СТОЛИЦЫ»**, ИНН `7702420143`, Lead ID `N5K-0391`.  
Итог physical canonical/contactable: **245 / 245**.  
...
## Latest verified run N5K-20260822-327
Canonical/contactable: 247/247. Integrity PASS. Orphan contacts/evidence: 0/0. Outreach: 0.
