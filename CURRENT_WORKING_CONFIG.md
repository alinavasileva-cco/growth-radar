...
**Версия:** 08.08.2026  
**Последний подтверждённый запуск:** `N5K-20260808-116`  
...
- baseline_count: **0**;
- текущий канонический итог: **84**;
- текущий contactable итог: **84**;
- осталось до цели: **4916**;
...
- последний отчёт: `reports/run_2026-08-08_116.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленная компания: **НАЦТРАНС / ООО «НАЦТРАНС»**;
