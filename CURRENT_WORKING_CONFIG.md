...
**Версия:** 08.08.2026  
**Последний подтверждённый запуск:** `N5K-20260808-126`  
...
- baseline_count: **0**;
- текущий канонический итог: **97**;
- текущий contactable итог: **97**;
- осталось до цели: **4903**;
...
- последний отчёт: `reports/run_2026-08-08_126.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **2**;
- добавленные компании: **Savin-Piar / ООО «САВИН - ПИАР»; FATFOX / ООО «ЦЕЛЕВЫЕ ПРОЕКТЫ»**;
