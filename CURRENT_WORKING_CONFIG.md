...
**Версия:** 11.08.2026  
**Последний запуск:** `N5K-20260811-190`  
**Статус:** `PENDING_MAIN_RUN_LOG_APPEND` — канонические данные интегрированы, integrity PASS; требуется безопасно добавить RUN 189 и RUN 190 в общий campaign run_log.csv  
...
- baseline_count: **0**;
- текущий канонический итог: **188**;
- текущий contactable итог: **188**;
- осталось до цели: **4812**;
...
- последний отчёт: `reports/run_2026-08-11_190.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавлен: `N5K-0188 Европодшипник М / ООО «ЕВРОПОДШИПНИК М»`;
...
- orphan contacts: **0**;
- orphan evidence: **0**;
- blocker: `PENDING_MAIN_RUN_LOG_APPEND_189_190`;
