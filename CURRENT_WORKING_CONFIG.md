...
**Версия:** 10.08.2026  
**Последний подтверждённый запуск:** `N5K-20260810-158`  
...
- baseline_count: **0**;
- текущий канонический итог: **145**;
- текущий contactable итог: **145**;
- осталось до цели: **4855**;
...
- последний отчёт: `reports/run_2026-08-10_158.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленных компаний: **1** — `N5K-0145 Ультра-Дент / ООО «УЛЬТРА-ДЕНТ»`;
