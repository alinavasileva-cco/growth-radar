...
**Версия:** 10.08.2026  
**Последний подтверждённый запуск:** `N5K-20260810-160`  
...
- baseline_count: **0**;
- текущий канонический итог: **147**;
- текущий contactable итог: **147**;
- осталось до цели: **4853**;
...
- последний отчёт: `reports/run_2026-08-10_160.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленных компаний: **1** — `N5K-0147 ПанельТЭК / ООО «ПАНЕЛЬТЭК»`;
