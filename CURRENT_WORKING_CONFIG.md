...
**Версия:** 08.08.2026  
**Последний подтверждённый запуск:** `N5K-20260808-129`  
...
- последний отчёт: `reports/run_2026-08-08_129.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленная компания: **Атмосферика / ООО «АТМОСФЕРИКА»**;
