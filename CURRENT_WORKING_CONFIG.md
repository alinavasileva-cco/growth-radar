...
**Версия:** 11.08.2026  
**Последний запуск:** `N5K-20260811-203`  
...
- baseline_count: **0**;
- текущий канонический итог: **203**;
- текущий contactable итог: **203**;
- осталось до цели: **4797**;
...
- последний отчёт: `reports/run_2026-08-11_203.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавлена: `N5K-0203 СК Развитие / Долговечные технологии / ООО «СК РАЗВИТИЕ»`;
...
- orphan contacts: **0**;
- orphan evidence: **0**;
- aggregate `run_log.csv`: RUN 198–203 ещё не добавлены безопасной полной заменой;
