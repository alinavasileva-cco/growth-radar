...
Текущее подтверждённое состояние replay: baseline 614; replay_total 60; checked 12; remaining 48; duplicates 4; excluded 8; legal_pass 3; scale_pass 1; signal_pass 0; LPR_pass 0; contact_pass 0; qualified/net_new 0/0; canonical/contactable 614/614; integrity PASS; orphan contacts/evidence 0/0; active_wip 0; outreach 0.

Следующий кандидат по сохранённому cursor: **ООО ПАУК**. Следующее выполнение обязано продолжить **тот же `N5K-20260904-631`**, а не создавать новый RUN и не запускать новый discovery.
