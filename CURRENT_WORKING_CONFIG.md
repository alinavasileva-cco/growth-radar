...
**Версия:** 11.08.2026  
**Последний запуск:** `N5K-20260811-182`  
...
- baseline_count: **0**;
- текущий канонический итог: **178**;
- текущий contactable итог: **178**;
- осталось до цели: **4822**;
...
- последний отчёт: `reports/run_2026-08-11_182.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленная компания: `N5K-0178 Реман-Сервис / ООО «РЕМАН-СЕРВИС»`;
...
- orphan contacts: **0**;
- orphan evidence: **0**;
- blocker: общий `data/campaigns/new_5000/run_log.csv` требует безопасного full-file append; отдельный RUN-log создан;
