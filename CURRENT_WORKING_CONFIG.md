...
**Версия:** 12.08.2026  
**Последний запуск:** `N5K-20260812-208`  
...
- baseline_count: **0**;
- текущий канонический итог: **208**;
- текущий contactable итог: **208**;
- осталось до цели: **4792**;
...
- последний отчёт: `reports/run_2026-08-12_208.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавлена: `N5K-0208 НАЦТРАНС / ООО «НАЦТРАНС»`;
...
- orphan contacts: **0**;
- orphan evidence: **0**;
- aggregate `run_log.csv`: RUN 198–208 ещё не добавлены безопасной полной заменой;
