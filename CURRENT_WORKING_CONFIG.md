...
**Версия:** 07.08.2026  
**Последний подтверждённый запуск:** `N5K-20260807-089`  
...
- baseline_count: **0**;
- текущий канонический итог: **52**;
- текущий contactable итог: **52**;
- осталось до цели: **4948**;
...
- последний отчёт: `reports/run_2026-08-07_089.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленные компании: **Торг-Лайт / ООО «ТОРГ-ЛАЙТ»**;
- дубли: **13**;
