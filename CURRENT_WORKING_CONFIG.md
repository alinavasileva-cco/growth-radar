...
**Версия:** 08.08.2026  
**Последний подтверждённый запуск:** `N5K-20260808-114`  
...
- baseline_count: **0**;
- текущий канонический итог: **81**;
- текущий contactable итог: **81**;
- осталось до цели: **4919**;
...
- последний отчёт: `reports/run_2026-08-08_114.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленная компания: **NL Group / ООО «ЭНЭЛ ГРУП»**;
