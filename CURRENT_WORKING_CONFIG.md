...
**Версия:** 12.08.2026  
**Последний запуск:** `N5K-20260812-207`  
...
- baseline_count: **0**;
- текущий канонический итог: **207**;
- текущий contactable итог: **207**;
- осталось до цели: **4793**;
...
- последний отчёт: `reports/run_2026-08-12_207.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавлена: `N5K-0207 Оценка.рф / Ocenka.tech / ООО «ТЕХНОЛОГИИ ОЦЕНКИ»`;
...
- orphan contacts: **0**;
- orphan evidence: **0**;
- aggregate `run_log.csv`: RUN 198–207 ещё не добавлены безопасной полной заменой;
