...
**Версия:** 11.08.2026  
**Последний запуск:** `N5K-20260811-200`  
...
- baseline_count: **0**;
- текущий канонический итог: **200**;
- текущий contactable итог: **200**;
- осталось до цели: **4800**;
...
- последний отчёт: `reports/run_2026-08-11_200.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавлена: `N5K-0200 World Machinery / ООО «ВОРЛД РУСЛАНД»`;
...
- orphan contacts: **0**;
- orphan evidence: **0**;
- aggregate `run_log.csv`: RUN 198–200 ещё не добавлены безопасной полной заменой;
