...
**Версия:** 09.08.2026  
**Последний подтверждённый запуск:** `N5K-20260809-148`  
...
- baseline_count: **0**;
- текущий канонический итог: **133**;
- текущий contactable итог: **133**;
- осталось до цели: **4867**;
...
- последний отчёт: `reports/run_2026-08-09_148.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленных компаний: **1** — `N5K-0133 REMAN SERVICE / Реман-Сервис / ООО «РЕМАН-СЕРВИС»`;
