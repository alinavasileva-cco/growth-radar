...
**Версия:** 10.08.2026  
**Последний подтверждённый запуск:** `N5K-20260810-161`  
...
- baseline_count: **0**;
- текущий канонический итог: **148**;
- текущий contactable итог: **148**;
- осталось до цели: **4852**;
...
- последний отчёт: `reports/run_2026-08-10_161.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленных компаний: **1** — `N5K-0148 SoftLike / ООО «СОФТ АЛЬЯНС»`;
