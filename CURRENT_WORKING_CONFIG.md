...
**Версия:** 08.08.2026  
**Последний подтверждённый запуск:** `N5K-20260808-110`  
...
- baseline_count: **0**;
- текущий канонический итог: **75**;
- текущий contactable итог: **75**;
- осталось до цели: **4925**;
...
- последний отчёт: `reports/run_2026-08-08_110.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленная компания: **Серьёзная Мебельная Фабрика / ООО «ПРОИЗВОДСТВЕННЫЙ ХОЛДИНГ»**;
