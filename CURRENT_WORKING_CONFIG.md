...
**Версия:** 08.08.2026  
**Последний подтверждённый запуск:** `N5K-20260808-113`  
...
- baseline_count: **0**;
- текущий канонический итог: **80**;
- текущий contactable итог: **80**;
- осталось до цели: **4920**;
...
- последний отчёт: `reports/run_2026-08-08_113.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленная компания: **Яркие Окна / ООО «ЯРКИЕ ОКНА»**;
