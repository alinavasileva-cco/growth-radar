...
**Версия:** 09.08.2026  
**Последний подтверждённый запуск:** `N5K-20260809-141`  
...
- baseline_count: **0**;
- текущий канонический итог: **120**;
- текущий contactable итог: **120**;
- осталось до цели: **4880**;
...
- последний отчёт: `reports/run_2026-08-09_141.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленных компаний: **1** — `N5K-0120 МЕГАТОНН / ООО «МЕГАТОНН»`;
