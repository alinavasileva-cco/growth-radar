...
**Версия:** 09.08.2026  
**Последний подтверждённый запуск:** `N5K-20260809-143`  
...
- baseline_count: **0**;
- текущий канонический итог: **123**;
- текущий contactable итог: **123**;
- осталось до цели: **4877**;
...
- последний отчёт: `reports/run_2026-08-09_143.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **2**;
- добавленных компаний: **2** — `N5K-0122 Авто Сувенир / ООО «АВТО СУВЕНИР»`, `N5K-0123 НАЦТРАНС / ООО «НАЦТРАНС»`;
