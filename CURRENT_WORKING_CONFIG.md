...
**Версия:** 11.08.2026  
**Последний запуск:** `N5K-20260811-201`  
...
- baseline_count: **0**;
- текущий канонический итог: **201**;
- текущий contactable итог: **201**;
- осталось до цели: **4799**;
...
- последний отчёт: `reports/run_2026-08-11_201.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавлена: `N5K-0201 Институт психологии Smart / ООО «ОНЛАЙН ИНСТИТУТ СМАРТ»`;
...
- orphan contacts: **0**;
- orphan evidence: **0**;
- aggregate `run_log.csv`: RUN 198–201 ещё не добавлены безопасной полной заменой;
