...
**Версия:** 10.08.2026  
**Последний подтверждённый запуск:** `N5K-20260810-163`  
...
- baseline_count: **0**;
- текущий канонический итог: **151**;
- текущий contactable итог: **151**;
- осталось до цели: **4849**;
...
- последний отчёт: `reports/run_2026-08-10_163.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленных компаний: **1** — `N5K-0151 ГК «Долговечные технологии» / ООО «СК РАЗВИТИЕ»`;
