...
**Версия:** 10.08.2026  
**Последний запуск:** `N5K-20260810-171`  
...
- baseline_count: **0**;
- текущий канонический итог: **162**;
- текущий contactable итог: **162**;
- осталось до цели: **4838**;
...
- последний отчёт: `reports/run_2026-08-10_171.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленная компания: `N5K-0162 ГК «Ангел» / АО ГРУППА КОМПАНИЙ «АНГЕЛ»`;
