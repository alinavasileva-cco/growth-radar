...
**Версия:** 12.08.2026  
**Последний запуск:** `N5K-20260812-218`  
**Статус:** `COMPLETED` — канонические RUN-shards интегрированы, integrity PASS, verified run-log tail продлён через RUN 218  
...
- baseline_count: **0**;
- текущий канонический итог: **222**;
- текущий contactable итог: **222**;
- осталось до цели: **4778**;
...
- последний отчёт: `reports/run_2026-08-12_218.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавлена: `N5K-0222 ГК Ангел / Ангел-Безопасность / АО ГРУППА КОМПАНИЙ «АНГЕЛ»`;
...
- orphan contacts: **0**;
- orphan evidence: **0**;
- verified tail дополнен RUN 218;
