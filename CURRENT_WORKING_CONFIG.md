...
**Версия:** 10.08.2026  
**Последний подтверждённый запуск:** `N5K-20260810-165`  
...
- baseline_count: **0**;
- текущий канонический итог: **154**;
- текущий contactable итог: **154**;
- осталось до цели: **4846**;
...
- последний отчёт: `reports/run_2026-08-10_165.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленных компаний: **1** — `N5K-0154 MARROB / ООО «МАРРОБ РУС»`;
