...
**Версия:** 12.08.2026  
**Последний запуск:** `N5K-20260812-205`  
...
- baseline_count: **0**;
- текущий канонический итог: **205**;
- текущий contactable итог: **205**;
- осталось до цели: **4795**;
...
- последний отчёт: `reports/run_2026-08-12_205.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавлена: `N5K-0205 Торг-Лайт / ООО «ТОРГ-ЛАЙТ»`;
...
- orphan contacts: **0**;
- orphan evidence: **0**;
- aggregate `run_log.csv`: RUN 198–205 ещё не добавлены безопасной полной заменой;
