...
**Версия:** 11.08.2026  
**Последний запуск:** `N5K-20260811-195`  
...
- baseline_count: **0**;
- текущий канонический итог: **194**;
- текущий contactable итог: **194**;
- осталось до цели: **4806**;
...
- последний отчёт: `reports/run_2026-08-11_195.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **2**;
- добавлены: `N5K-0193 YURSUS / ИП Гармаш Юрий Владимирович`; `N5K-0194 Руслитекс / ООО «РУСЛИТЕКС»`;
...
- orphan contacts: **0**;
- orphan evidence: **0**;
- blocker: общий `data/campaigns/new_5000/run_log.csv` ещё не дополнен RUN 193–195; blob SHA получен, файл прочитан полностью диапазонами, discovery и каноническая интеграция не останавливались;
