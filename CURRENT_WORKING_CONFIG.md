...
**Версия:** 15.08.2026  
**Последний запуск:** `N5K-20260815-237`  
**Статус:** `COMPLETED` — integrity PASS; добавлены 4 новые квалифицированные компании  
...
- baseline_count: **0**;
- текущий канонический итог: **246**;
- текущий contactable итог: **246**;
- осталось до текущей цели 5000: **4754**;
...
- последний отчёт: `reports/run_2026-08-15_237.md`.

## Последний RUN — N5K-20260815-237
...
- квалифицировано и добавлено: **4**;
- подтверждённые дубли: **0**;
- исключено / не прошло обязательные гейты: **26**;
- добавленные компании: **Авто Сувенир**, **Медальянс Клиник**, **КОСИМА**, **REMONT.IO**;
- новый итог: **246 canonical / 246 contactable**;
- integrity: **PASS**;
- orphan contacts: **0**;
- orphan evidence: **0**;
- outreach sent: **0**;
