...
**Версия:** 10.08.2026  
**Последний подтверждённый запуск:** `N5K-20260810-164`  
...
- baseline_count: **0**;
- текущий канонический итог: **153**;
- текущий contactable итог: **153**;
- осталось до цели: **4847**;
...
- последний отчёт: `reports/run_2026-08-10_164.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **2**;
- добавленных компаний: **2** — `N5K-0152 Прометекс / ООО «ПРОМЕТЕКС»`, `N5K-0153 GOOD WOOD / ООО «ГУД ВУД»`;
