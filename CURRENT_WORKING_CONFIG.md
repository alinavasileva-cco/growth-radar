...
**Версия:** 08.08.2026  
**Последний подтверждённый запуск:** `N5K-20260808-127`  
...
- baseline_count: **0**;
- текущий канонический итог: **99**;
- текущий contactable итог: **99**;
- осталось до цели: **4901**;
...
- последний отчёт: `reports/run_2026-08-08_127.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **2**;
- добавленные компании: **Линии Света / ACELED / ООО «ТОРГ-ЛАЙТ»; ООО «ПОДРЯД» / системы безопасности**;
