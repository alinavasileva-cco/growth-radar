...
**Версия:** 07.08.2026  
**Последний подтверждённый запуск:** `N5K-20260807-090`  
...
- baseline_count: **0**;
- текущий канонический итог: **53**;
- текущий contactable итог: **53**;
- осталось до цели: **4947**;
...
- последний отчёт: `reports/run_2026-08-07_090.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленные компании: **Парус / ООО «ПАРУС»**;
- дубли: **13**;
