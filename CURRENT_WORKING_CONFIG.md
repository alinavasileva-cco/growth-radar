...
**Версия:** 12.08.2026  
**Последний запуск:** `N5K-20260812-215`  
**Статус:** `COMPLETED` — канонические RUN-shards интегрированы, integrity PASS, verified run-log tail продлён через RUN 215  
...
- baseline_count: **0**;
- текущий канонический итог: **219**;
- текущий contactable итог: **219**;
- осталось до цели: **4781**;
...
- последний отчёт: `reports/run_2026-08-12_215.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавлена: `N5K-0219 РВШ.РФ / ООО «РВШ.РФ»`;
...
- orphan contacts: **0**;
- orphan evidence: **0**;
- verified tail дополнен RUN 215;
