...
**Версия:** 10.08.2026  
**Последний запуск:** `N5K-20260810-172`  
...
- baseline_count: **0**;
- текущий канонический итог: **165**;
- текущий contactable итог: **165**;
- осталось до цели: **4835**;
...
- последний отчёт: `reports/run_2026-08-10_172.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **3**;
- добавленные компании: `N5K-0163 Клуб Бизнес Авиация`, `N5K-0164 Инновации`, `N5K-0165 Европодшипник М`;
