...
**Версия:** 09.08.2026  
**Последний подтверждённый запуск:** `N5K-20260809-142`  
...
- baseline_count: **0**;
- текущий канонический итог: **121**;
- текущий contactable итог: **121**;
- осталось до цели: **4879**;
...
- последний отчёт: `reports/run_2026-08-09_142.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленных компаний: **1** — `N5K-0121 Деметра / ООО «ДЕМЕТРА»`;
