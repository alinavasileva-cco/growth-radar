...
**Версия:** 08.08.2026  
**Последний подтверждённый запуск:** `N5K-20260808-119`  
...
- baseline_count: **0**;
- текущий канонический итог: **89**;
- текущий contactable итог: **89**;
- осталось до цели: **4911**;
...
- последний отчёт: `reports/run_2026-08-08_119.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленная компания: **МосВектор / ООО «МОСВЕКТОР»**;
