...
**Версия:** 08.08.2026  
**Последний подтверждённый запуск:** `N5K-20260808-125`  
...
- baseline_count: **0**;
- текущий канонический итог: **95**;
- текущий contactable итог: **95**;
- осталось до цели: **4905**;
...
- последний отчёт: `reports/run_2026-08-08_125.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленная компания: **ГК «Ангел» / Ангел-Безопасность / АО ГРУППА КОМПАНИЙ «АНГЕЛ»**;
