...
**Версия:** 09.08.2026  
**Последний подтверждённый запуск:** `N5K-20260809-153`  
...
- baseline_count: **0**;
- текущий канонический итог: **140**;
- текущий contactable итог: **140**;
- осталось до цели: **4860**;
...
- последний отчёт: `reports/run_2026-08-09_153.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **2**;
- добавленных компаний: **2** — `N5K-0139 Прометекс / ООО «ПРОМЕТЕКС»`, `N5K-0140 MORE METIZOV / ООО «МОРЕ-МЕТИЗОВ»`;
