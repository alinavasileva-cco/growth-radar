...
**Версия:** 07.08.2026  
**Последний подтверждённый запуск:** `N5K-20260807-093`  
...
- baseline_count: **0**;
- текущий канонический итог: **57**;
- текущий contactable итог: **57**;
- осталось до цели: **4943**;
...
- последний отчёт: `reports/run_2026-08-07_093.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **2**;
- добавленные компании: **Третье Чувство / ООО «ТРЕТЬЕ ЧУВСТВО»; ВЕГАЛИБР / ООО «ВЕГАЛИБР»**;
- подтверждённые дубли: **0**;
- исключено или не прошло полную квалификацию: **28**;
- ACTIVE WIP: **8**;
- integrity: **PASS**;
- orphan contacts: **0**;
- orphan evidence: **0**;
- repair: не требовался;
- blocker: отсутствует; квалифицированные компании прошли legal → scale → LPR → signal → contact и записаны во все канонические RUN-shards.