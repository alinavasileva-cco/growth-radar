...
**Версия:** 09.08.2026  
**Последний подтверждённый запуск:** `N5K-20260809-138`  
...
- baseline_count: **0**;
- текущий канонический итог: **117**;
- текущий contactable итог: **117**;
- осталось до цели: **4883**;
...
- последний отчёт: `reports/run_2026-08-09_138.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленных компаний: **1** — `N5K-0117 ГК Ангел / АО ГРУППА КОМПАНИЙ «АНГЕЛ»`;
