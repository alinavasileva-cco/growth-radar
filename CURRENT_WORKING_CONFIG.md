...
- baseline_count: **0**;
- текущий канонический итог: **190**;
- текущий contactable итог: **190**;
- осталось до цели: **4810**;
...
- последний отчёт: `reports/run_2026-08-11_192.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавлен: `N5K-0190 Экотория / ИП Сипягина Анастасия Анатольевна`;
