...
**Версия:** 08.08.2026  
**Последний подтверждённый запуск:** `N5K-20260808-108`  
...
- baseline_count: **0**;
- текущий канонический итог: **73**;
- текущий contactable итог: **73**;
- осталось до цели: **4927**;
...
- последний отчёт: `reports/run_2026-08-08_108.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленная компания: **Мотус Москва / ООО «МОТУС МОСКВА»**;
