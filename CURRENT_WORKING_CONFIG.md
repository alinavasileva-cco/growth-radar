...
**Версия:** 10.08.2026  
**Последний подтверждённый запуск:** `N5K-20260810-156`  
...
- baseline_count: **0**;
- текущий канонический итог: **143**;
- текущий contactable итог: **143**;
- осталось до цели: **4857**;
...
- последний отчёт: `reports/run_2026-08-10_156.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленных компаний: **1** — `N5K-0143 СП Групп / ООО «СП ГРУПП»`;
