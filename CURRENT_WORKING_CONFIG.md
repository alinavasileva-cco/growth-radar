...
- baseline_count: **0**;
- текущий канонический итог: **195**;
- текущий contactable итог: **195**;
- осталось до цели: **4805**;
...
- последний отчёт: `reports/run_2026-08-11_196.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавлена: `N5K-0195 REMAN SERVICE / ООО «РЕМАН-СЕРВИС»`;
