...
**Версия:** 09.08.2026  
**Последний подтверждённый запуск:** `N5K-20260809-133`  
...
- baseline_count: **0**;
- текущий канонический итог: **107**;
- текущий contactable итог: **107**;
- осталось до цели: **4893**;
...
- последний отчёт: `reports/run_2026-08-09_133.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **3**;
- добавленных компаний: **3** — `N5K-0105 Клик Инвест`, `N5K-0106 MARROB`, `N5K-0107 ANGFA / Поинкэр`;
