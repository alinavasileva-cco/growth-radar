...
**Версия:** 11.08.2026  
**Последний запуск:** `N5K-20260811-198`  
...
- baseline_count: **0**;
- текущий канонический итог: **197**;
- текущий contactable итог: **197**;
- осталось до цели: **4803**;
...
- последний отчёт: `reports/run_2026-08-11_198.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавлена: `N5K-0197 Авто Сувенир / PD Present Day / ООО «АВТО СУВЕНИР»`;
...
- orphan contacts: **0**;
- orphan evidence: **0**;
- aggregate `run_log.csv`: RUN 198 ещё не добавлен безопасной полной заменой;
