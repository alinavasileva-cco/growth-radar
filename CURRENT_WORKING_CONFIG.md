...
**Версия:** 08.08.2026  
**Последний подтверждённый запуск:** `N5K-20260808-122`  
...
- baseline_count: **0**;
- текущий канонический итог: **92**;
- текущий contactable итог: **92**;
- осталось до цели: **4908**;
...
- последний отчёт: `reports/run_2026-08-08_122.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленная компания: **Авто Сувенир / ООО «АВТО СУВЕНИР»**;
...
- blocker: отсутствует; компания прошла legal → scale → LPR → signal → contact и записана во все канонические RUN-shards.