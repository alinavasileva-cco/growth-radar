...
**Версия:** 09.08.2026  
**Последний подтверждённый запуск:** `N5K-20260809-151`  
...
- baseline_count: **0**;
- текущий канонический итог: **137**;
- текущий contactable итог: **137**;
- осталось до цели: **4863**;
...
- последний отчёт: `reports/run_2026-08-09_151.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленных компаний: **1** — `N5K-0137 ГК Ангел / АО ГРУППА КОМПАНИЙ «АНГЕЛ»`;
