...
**Версия:** 10.08.2026  
**Последний подтверждённый запуск:** `N5K-20260810-166`  
...
- baseline_count: **0**;
- текущий канонический итог: **155**;
- текущий contactable итог: **155**;
- осталось до цели: **4845**;
...
- последний отчёт: `reports/run_2026-08-10_166.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленных компаний: **1** — `N5K-0155 Flaconia Pro / ИП Филигаров Максим Игоревич`;
