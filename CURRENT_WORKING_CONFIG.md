...
**Версия:** 11.08.2026  
**Последний запуск:** `N5K-20260811-194`  
...
- baseline_count: **0**;
- текущий канонический итог: **192**;
- текущий contactable итог: **192**;
- осталось до цели: **4808**;
...
- последний отчёт: `reports/run_2026-08-11_194.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавлен: `N5K-0192 Торг-Лайт / ООО «ТОРГ-ЛАЙТ»`;
...
- orphan contacts: **0**;
- orphan evidence: **0**;
- blocker: общий `data/campaigns/new_5000/run_log.csv` ещё не дополнен RUN 193–194; blob прочитан по требуемой схеме, discovery и каноническая интеграция не останавливались;
