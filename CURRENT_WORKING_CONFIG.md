...
**Версия:** 2026-08-26T12:04:00+03:00  
**Последний полностью завершённый RUN:** `N5K-20260826-427`  
**Статус канонической базы:** ACTIVE / integrity PASS  
**Физически подтверждённый canonical/contactable:** **384 / 384**  
...
- physical canonical/contactable count: **384 / 384**;
- orphan contacts/evidence: **0 / 0**;
- последний завершённый RUN: `N5K-20260826-427`;
...
## Последний подтверждённый RUN — N5K-20260826-427

Baseline перед RUN: **383 / 383**.  
Фактически обработано **12** разных raw-кандидатов; целевые 300–500 не достигнуты.  
Воронка: discovered **12** → fast gate **1** → size **1** → legal **1** → signal **1** → LPR **1** → contact **1** → qualified **1** → physically integrated **1**.  
Duplicates: **0**. Excluded: **11**.

Добавлена:
- **Анатомика**, ООО «АНАТОМИКА», ИНН `1657194650`, ОГРН `1151690031790`, Lead ID `N5K-0536`.

Итог physical canonical/contactable: **384 / 384**.  
Integrity: **PASS**. Orphan contacts/evidence: **0 / 0**. Active WIP: **0**. Staged: **0**. Outreach: **0**.

### Discovery-lanes RUN 427

- HH/job-board: raw **0**, duplicate/early reject **0**, qualified **0**; насыщенный lane не пересканировался как основной;
- other job boards: raw **1**, duplicate/early reject **1**, qualified **0**;
- industry catalogs: raw **3**, duplicate/early reject **2**, qualified **1**;
- regional business catalogs/news: raw **2**, duplicate/early reject **1**, qualified **1**; тот же qualified считается один раз глобально;
...
Фактическое узкое место RUN 427 — объём аудируемого low-overlap discovery. Лучший новый кандидат пришёл из industry/growth/regional expansion-потока; качество deep funnel не снижалось.
...
## Latest verified run N5K-20260826-427
Canonical/contactable: 384/384. Integrity PASS. Orphan contacts/evidence: 0/0. Outreach: 0.
...
## Latest verified run N5K-20260826-428
Canonical/contactable: 385/385. Integrity PASS. Orphan contacts/evidence: 0/0. Outreach: 0.
