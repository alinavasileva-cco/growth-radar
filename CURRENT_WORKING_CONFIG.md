...
**Версия:** 08.08.2026  
**Последний подтверждённый запуск:** `N5K-20260808-112`  
...
- baseline_count: **0**;
- текущий канонический итог: **79**;
- текущий contactable итог: **79**;
- осталось до цели: **4921**;
...
- последний отчёт: `reports/run_2026-08-08_112.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **2**;
- добавленные компании: **Союз Девелоперов Москвы / ООО «ЕКЦН»**; **Бластим / ООО «БЛАСТИМ»**;
