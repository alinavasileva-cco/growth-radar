...
**Версия:** 07.08.2026  
**Последний подтверждённый запуск:** `N5K-20260807-083`  
...
- последний отчёт: `reports/run_2026-08-07_083.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленная компания: **Chacha's Club / ИП Кожомин Кирилл Павлович**;
- дубли: **13**;
