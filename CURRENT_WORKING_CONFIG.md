...
**Версия:** 15.08.2026  
**Последний запуск:** `N5K-20260815-236`  
...
- baseline_count: **0**;
- текущий канонический итог: **242**;
- текущий contactable итог: **242**;
- осталось до текущей цели 5000: **4758**;
...
- последний отчёт: `reports/run_2026-08-15_236.md`.

## Последний RUN — N5K-20260815-236

- найдено сырых кандидатов: **30**;
- квалифицировано и добавлено: **3**;
- подтверждённые дубли: **0**;
- исключено / не прошло обязательные гейты: **27**;
- добавленные компании: **Рус-Лайн Инжиниринг**, **РИТСО-Консалтинг**, **СИАРЕС / CRS Company**;
- новый итог: **242 canonical / 242 contactable**;
- integrity: **PASS**;
- orphan contacts: **0**;
- orphan evidence: **0**;
- outreach sent: **0**;
...
## Важные решения RUN 236

- ООО «СМАРТСОФТ» / СмартЛомбард не добавлено: юрлицо, масштаб и маршрут связи подтверждены, но свежий сигнал на внешнее коммерческое вмешательство недостаточно сильный для обязательного signal-gate.
- ООО «СИСТЕМА НАЙМА» / Идеальный турник не добавлено: по реестровым данным среднесписочная численность 1 сотрудник, что не проходит рабочий size-gate.
- Рус-Лайн Инжиниринг допущен при выручке выше предпочтительных 300 млн ₽, но ниже 500 млн ₽: есть сильный S1 и собственник 100% одновременно является гендиректором.
