...
**Версия:** 07.08.2026  
**Последний подтверждённый запуск:** `N5K-20260807-088`  
...
- baseline_count: **0**;
- текущий канонический итог: **51**;
- текущий contactable итог: **51**;
- осталось до цели: **4949**;
...
- последний отчёт: `reports/run_2026-08-07_088.md`.

## Последний RUN

- найдено сырых кандидатов: **30**;
- квалифицировано: **1**;
- добавленные компании: **ПанельТЭК / ООО «ПАНЕЛЬТЭК»**;
- дубли: **13**;
